...
from tesi.climate.utility_scripts import crops_data, future_climate_data
...
class PastClimateDataRepository:
    ...
    async def download_past_climate_data_into_db(self, longitude: float, latitude: float):
    ...
    async def get_future_predictions_for_coordinates(
